# Generated by Django 4.0.5 on 2022-08-26 14:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idiva', models.ForeignKey(blank=True, db_column='idIVA', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='general.iva')),
                ('idusuario', models.ForeignKey(blank=True, db_column='idUsuario', null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'productos',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idcolor', models.ForeignKey(db_column='idColor', on_delete=django.db.models.deletion.CASCADE, to='general.colores')),
                ('idestado', models.ForeignKey(blank=True, db_column='idEstado', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='general.estados')),
                ('idproducto', models.ForeignKey(db_column='idProducto', on_delete=django.db.models.deletion.CASCADE, to='general.productos')),
                ('idtalla', models.ForeignKey(db_column='idTalla', on_delete=django.db.models.deletion.CASCADE, to='general.tallas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idpromocion', models.ForeignKey(blank=True, db_column='idPromocion', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='general.promociones')),
            ],
            options={
                'db_table': 'lineacesta',
            },
        ...
        migrations.AddField(
            model_name='cestas',
            name='idestados',
            field=models.ForeignKey(blank=True, db_column='idEstados', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='general.estados'),
        ),
        migrations.AddField(
            model_name='cestas',
            name='idusuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('idproducto', models.OneToOneField(db_column='idProducto', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='general.productos')),
                ('idimagen', models.ForeignKey(db_column='idImagen', on_delete=django.db.models.deletion.CASCADE, to='general.imagenes')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('iddiseno', models.OneToOneField(db_column='idDiseno', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='general.disenos')),
                ('idcategoria', models.ForeignKey(db_column='idCategoria', on_delete=django.db.models.deletion.CASCADE, to='general.categorias')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Clienteimagen',
            fields=[
                ('idcliente', models.OneToOneField(db_column='idCliente', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='general.clientes')),
                ('idimagen', models.ForeignKey(db_column='idImagen', on_delete=django.db.models.deletion.CASCADE, to='general.imagenes')),
            ],
            options={
